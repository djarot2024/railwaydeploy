...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-brand d-flex align-items-center justify-content-center">
                <div>
                <img src="{{ asset('img/logo_laundry.png') }}" alt="Wuzz Laundry" style="width: 110px;">
                </div>
                <!-- <div class="sidebar-brand-text mx-3">WUZZ LAUNDRY</div> -->
            </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/">
                    ...
                    <span>Laundrykuu</span></a>
            </li>
                        
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="/cucianku">
                    <i class="fas fa-fw fa-tshirt"></i>
                    <span>Cuciankuu</span></a>
            </li>

            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="/pelangganku">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Pelanggankuu</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                Admin @if(Auth::check()){{ Auth::user() ->name}}@endif
                                </span>
                            </a>
    ...
    <script type="text/javascript">
        Swal.fire({
            icon: 'success',
            title: 'Login Sukses',
            text: "Hai {{ session('successlogin') }}, Anda berhasil login!",
        });
    </script>
    @endif
