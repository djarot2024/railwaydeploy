                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2 font-weight-bold">Selamat Datang di <br> Wuzz Laundry</h1>
                                        <p>Silahkan Registrasi Terlebih Dahulu</p>
                                    </div>
                                    <form class="user" action="{{ route('registrasi.submit') }}" method="post">
                                        @csrf
                                    ...
                                    <div class="text-start pt-1">
                                        <a class="small" href="/login">Login Jika Memiliki Akun</a>
                                    </div>
                                </div>
                            </div>
                        </div>
